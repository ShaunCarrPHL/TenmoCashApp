...
public class JdbcAccountDao implements AccountDao {
    ...
    public BigDecimal getBalance(long userId) {
        ...
        try {
            String getBalanceById =  "SELECT balance FROM account WHERE user_id = ?;";
    ...
    public Account findUserWithId(long userId) {
        ...
        String getAccountFromUserId = "SELECT * FROM account WHERE user_id = ?;";
    ...
    public Account findAccountWithId(long accountId) {
        ...
        String getAccountFromAccountId = "SELECT balance, account_id, user_id FROM account WHERE account_id = ?;";
